...
partial class FormularioCadastrarDoutores
{
	/// <summary>
	...
	private void InitializeComponent()
	{
		...
		Txt_Sessoes = new TextBox();
		label14 = new Label();
		label15 = new Label();
		Txt_Turnos = new TextBox();
		comboBox_Vencimento = new ComboBox();
		SuspendLayout();
		// 
		// label12
		// 
		...
		Controls.Add(label9);
		Controls.Add(label8);
		Controls.Add(Txt_Especialidade);
		Controls.Add(label7);
		Controls.Add(Txt_RG);
		Controls.Add(Lbl_ID);
		Controls.Add(label6);
	...
	private TextBox Txt_Sessoes;
	private Label label14;
	private Label label15;
	private TextBox Txt_Turnos;
	private ComboBox comboBox_Vencimento;
}